<div class="row">
	<div class="col-8">
		<div class="mb-2">
			<a type="button" onclick="fn.app.production_prepare.prepare.dialog_add_pack(<?php echo $production['id'];?>)" class="btn btn-primary mr-2">เพิ่มถุง</a>
			<a type="button" onclick="fn.app.production_prepare.prepare.calculation()" class="btn btn-warning">Calculate</a>
		...
		<table id="tblPacking" data-id="<?php echo $production['id'];?>" class="mt-2 table table-bordered">
			...
			/*
				...
				while($pack = $dbc->Fetch($rst)){
					...
					echo '<tr>';
						echo '<td><a onclick="fn.app.production_prepare.prepare.remove_pack(this);" href="javascript:;" class="btn btn-sm btn-danger">X</a>';
