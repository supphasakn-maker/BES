<div class="mb-2">
	<form name="report">
		<div class="form-group row">
			...
			<label class="col-sm-1 col-form-label text-right">ธนาคาร</label>
			<div class="col-sm-2">
			...
			<div class="col-sm-2">
				<button type="button" class="btn btn-primary" onclick="fn.app.report_financial.generate();return false;">Search</button>
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row display-group" display-group="default">
