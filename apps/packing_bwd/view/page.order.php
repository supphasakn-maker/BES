            ...
            <div class="table-card">
                ...
                <div class="table-header">
                    <div class="header-content">
                        ...
                        <div>
                            <h3 class="header-title">Packing Bowins Design</h3>
                    ...
                    <div class="btn-area btn-group mb-3">
                        <form name="filter" class="form-inline mr-2" onsubmit="return false;">
                            <div class="form-group mr-3">
                                ...
                                <input name="from" type="date" class="form-control custom-date-input"
                                    value="<?php echo date("Y-m-d", $today - (86400 * 5)); ?>"
                                    max="<?php echo date("Y-m-d", $today + (86400 * 30)); ?>">
                        ...
                        <table id="tblOrder" class="table table-sm table-striped table-bordered table-hover table-middle custom-datatable" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center th-order-date">วันที่สั่งซื้อ</th>
                                    <th class="text-center th-delivery-date">วันที่ส่งของ</th>
                                    <th class="text-center th-sales">ผู้ขาย</th>
                                    <th class="text-center th-sales">จัดเตรียม</th>
                                    <th class="text-center th-sales">วันที่จัดเตรียม</th>
                                    <th class="text-center th-sales">Tracking</th>
                                    <th class="text-center th-schedule" id="schedule_header">
                                        ตารางส่งของ
                                    </th>
                                </tr>
                            </thead>
