...
class myModel extends imodal
{
    ...
    {
        $dbc = $this->dbc;
        $production = $dbc->GetRecord("bs_productions_switch", "*", "id=" . $this->param['id']);
        echo '<form name="form_approveswitch">';
...
$modal->setModel("dialog_approve_switch", "APPROVE");
$modal->setButton(array(
    array("close", "btn-secondary", "Dismiss"),
    array("action", "btn-danger", "Approve", "fn.app.production_switch.switch.approve()")
));
$modal->EchoInterface();
