<?php
	...
	$columns = array(
		"id" => "bs_pmr_pack_items.id",
		"pmr_id" => "bs_pmr_pack_items.pmr_id",
		"item_type" => "bs_pmr_pack_items.item_type",
		"item_id" => "bs_pmr_pack_items.item_id",
		"remark" => "bs_pmr_pack_items.remark",
		"mapping" => "bs_pmr_pack_items.mapping",
