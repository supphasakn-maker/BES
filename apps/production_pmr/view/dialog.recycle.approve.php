...
class myModel extends imodal
{
    function body()
    {
        ...
        echo '<form name="form_approverecycle">';
...
$modal->setModel("dialog_approve_recycle", "Recycle Prepare");
$modal->setButton(array(
    array("close", "btn-secondary", "Dismiss"),
    array("action", "btn-danger", "Approve", "fn.app.production_pmr.recycle.approve()")
));
$modal->EchoInterface();
