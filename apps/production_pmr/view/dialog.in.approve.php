...
class myModel extends imodal
{
    ...
    {
        $dbc = $this->dbc;
        $production = $dbc->GetRecord("bs_productions_in", "*", "id=" . $this->param['id']);
        echo '<form name="form_approvein">';
...
$modal->setModel("dialog_approve_in", "Approve");
$modal->setButton(array(
    array("close", "btn-secondary", "Dismiss"),
    array("action", "btn-danger", "Approve", "fn.app.production_pmr.in.approve()")
));
$modal->EchoInterface();
