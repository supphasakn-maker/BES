...
$furnace = $dbc->GetRecord("bs_productions_furnace", "*", "round=" . $_GET['production_id']);
...
$silver_save = $dbc->GetRecord("bs_productions_silver_save", "*", "round =" . $_GET['production_id']);
...
WHERE bs_productions.approver_weight = '" . $production['approver_weight'] . "' AND bs_productions.id ='" . $_GET['production_id'] . "'";
$rst = $dbc->Query($sql);
$approver_weight = $dbc->Fetch($rst);

$sql = "SELECT bs_employees.fullname FROM bs_employees
LEFT OUTER JOIN bs_productions ON bs_productions.approver_general = bs_employees.id
WHERE bs_productions.approver_general = '" . $production['approver_general'] . "' AND bs_productions.id ='" . $_GET['production_id'] . "'";
$rst = $dbc->Query($sql);
        ...
        <div class="row">
            <div class="col-7 small-text mt-3">
                <dl class="row col-8 offset-0">
                    ...
                    <dd class="col-6 mt-2 under-line"> <?php echo $get_product['name']; ?></dd>
                    <dt class="col-6 mt-2">แท่งเงินใช้หลอม :</dt>
                    <dd class="col-6 mt-2 under-line"> <?php echo $get_product_out['name']; ?></dd>
                        ...
                        if (isset($production['data']))
                            if ($production['data'] != null) {
                                ...
                                foreach ($data['import'] as $import) {
                                    ...
                                    echo $import['import_weight_bar'] . '<br />';
                                }
                            }
                        ?>
                    </td>
            ...
            <table border="1" style="width:100%">
                    ...
                    <td>
                            ...
                            <div class="col">
                                <div class="col-6 under-line ">
                                    ...
                                    if (!empty($production['weight_in_safe']) || ($production['pack_type'] == 'ถุงรวมเศษ')) {
                                        $sqlscrap = "SELECT * FROM bs_scrap_items WHERE production_id= " . $_GET['production_id'] . " AND pack_name = 'เศษเสียรอการผลิตนำเข้า' ";
                                        ...
                                        WHERE parent = '" . $scrap['id'] . "' ";
                                            ...
                                            while ($productions = $dbc->Fetch($rst1)) {
                                                $get_product = $dbc->GetRecord("bs_productions", "*", "id=" . $productions['production_id']);

                                                echo '' . $get_product['round'] . '<br />';
                                            }
                                        }
                                    } else  if (($production['product_id'] == '4') || ($production['product_id'] == '3') || ($production['product_id'] == '1') || ($production['product_id'] == '6') || ($production['product_id'] == '2')) {
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="col-6 under-line ">
                                    <?php
                                    if ($production['PMR'] == 'PMR' || ($production['product_id'] == '4') || ($production['product_id'] == '3') || ($production['product_id'] == '1') || ($production['product_id'] == '6') || ($production['product_id'] == '2')) {
                                        if (isset($production['data'])) {
                                            if ($production['data'] != null) {
                                                $data = json_decode($production['data'], true);
                                                foreach ($data['import'] as $import) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <?php
                                if ($silver_save['bar'] == '0.0000') {
                                    echo "-";
                                } else {
                                    echo $silver_save['bar'] . 'Kgs.';
                                }
                            ...
                            <div class="col">
                                <?php
                                if ($silver_save['amount'] == '0.0000') {
                                    echo "-";
                                } else {
                                    echo $silver_save['amount'] . 'Kgs.';
                                }
                                ?>Kgs.
                            </div>
                        </div>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div class="row">
                            <div class="col">เวลา <?php echo $silver_save['time']; ?>น.</div>
                            <div class="col">ลงชื่อ <?php echo $silver_save['user']; ?></div>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div class="row">
                            <div class="col">ผู้บันทึกเข้า ลงชื่อ <?php echo $approver_weight['fullname']; ?> (ตัวบรรจง)</div>
                            <div class="col">ผู้บันทึกออก ลงชื่อ <?php echo $approver_general['fullname']; ?> (ตัวบรรจง)</div>
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <table border="1" style="width:100%">
        <thead">
            ...
            <tbody>
                ...
                WHERE production_id = '" . $_GET['production_id'] . "' AND pack_name != 'เศษเสียรอการผลิตนำเข้า'";
                $rst = $dbc->Query($sql);
                $number = 1;
            ...
            <div class="row">
                <div class="col-6 small-text mt-3">
                    <dl class="row col-8 offset-0">
                        ...
                        <dd class="col-6 mt-2 under-line"><?php echo $getmin['min']; ?> - <?php echo $getmax['max']; ?></dd>
                    </dl>
                </div>
            ...
            <span class="page-number">
                <table class="p-5 mt-2" width="100%">
                    ...
                    <tbody>
                        ...
                        bs_packing_items.pack_type,bs_packing_items.weight_actual,bs_packing_items.weight_expected,bs_productions.round,bs_productions.id
                        FROM bs_packing_items 
                        LEFT OUTER JOIN bs_productions ON bs_packing_items.production_id = bs_productions.id
                        WHERE bs_packing_items.production_id = '" . $_GET['production_id'] . "'
                        ...
                        while ($product = $dbc->Fetch($rst)) {
                            if (!empty($product['weight_in_safe']) || ($product['pack_type'] == 'ถุงรวมเศษ')) {
                                $scrap = $dbc->GetRecord("bs_scrap_items", "*", "production_id=" . $_GET['production_id'] . " AND pack_name = 'เศษเสียรอการผลิตนำเข้า'");
                                $scrap_parent = $dbc->GetRecord("bs_scrap_items", "*", "parent=" . $scrap['id']);
                                $get_product = $dbc->GetRecord("bs_productions", "*", "id=" . $scrap_parent['production_id']);
