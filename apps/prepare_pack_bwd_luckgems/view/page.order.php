            ...
            <div class="table-card">
                <div class="table-header">
                    <div class="header-content">
                        ...
                        <div>
                            <h3 class="header-title">ตาราง Packing Luckgems</h3>
                            <p class="header-subtitle">Bowins Design Packing</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="tblOrder" class="table table-sm table-striped table-bordered table-hover table-middle custom-datatable" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center th-sales">รับจริง</th>
                                    <th class="text-center th-sales">วันที่รับจริง</th>
                                </tr>
                            </thead>
                            <tbody>
