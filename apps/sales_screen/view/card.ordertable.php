		...
		<div class="tab-content" id="HistoryTabContent">
			<div class="tab-pane fade show active" id="order-history" role="tabpanel" aria-labelledby="order-history-tab">
				<table id="tblDailyTable" class="datatable table table-striped table-sm table-bordered dt-responsive nowrap">
					<thead class="bg-dark">
						<tr>
							<th class="text-center text-white" style="width: 40px; font-size: 12px">PO</th>
							<th class="text-center text-white" style="width: 60px; font-size: 12px">DATE</th>
							<th class="text-center text-white" style="width: 60px; font-size: 12px">DELIVERY</th>
							<th class="text-center text-white" style="width: 40px; font-size: 12px">KG</th>
							<th class="text-center text-white" style="width: 50px; font-size: 12px">B/KG</th>
							<th class="text-center text-white" style="width: 40px; font-size: 12px">VAT</th>
							<th class="text-center text-white" style="width: 60px; font-size: 12px">TOTAL</th>
							<th class="text-center text-white" style="width: 40px; font-size: 12px">USD</th>
							<th class="text-center text-white" style="width: 50px; font-size: 12px">SALES</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
					<tbody>
						<tr>
							...
							<th class="text-center"></th>
							<th class="text-center" xname="tValue"></th>
							<th class="text-center"></th>
							<th class="text-center"></th>
