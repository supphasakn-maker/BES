<?php
	...
	$columns = array(
		"id" => "bs_delivery_pack_items.id",
		"delivery_id" => "bs_delivery_pack_items.delivery_id",
		"item_type" => "bs_delivery_pack_items.item_type",
		"item_id" => "bs_delivery_pack_items.item_id",
		"remark" => "bs_delivery_pack_items.remark",
		"mapping" => "bs_delivery_pack_items.mapping",
