...
<style>
	...
	#tblSpot thead th:not(:last-child)::after {
		content: '';
		position: absolute;
		right: 0;
		top: 25%;
	...
	#tblSpot tbody tr:last-child td {
		border-bottom: none;
	}
		...
		<div class="col-xl-9 col-lg-8">
			<div class="data-section">
				...
				<div class="table-responsive">
					<table id="tblSpot" class="table table-striped table-hover" width="100%">
						<thead class="bg-dark">
							<tr>
								<th class="text-center text-white">วันที่/เวลา</th>
								<th class="text-center text-white">วันที่ขาย</th>
								<th class="text-center text-white">ประเภท</th>
								<th class="text-center text-white">ขายกับ</th>
								<th class="text-center text-white">จำนวน</th>
								<th class="text-center text-white">Spot</th>
								<th class="text-center text-white">ผู้ขาย</th>
								<th class="text-center text-white">Supplier ADJ</th>
								<th class="text-center text-white">Maturity</th>
								<th class="text-center text-white">Comment</th>
								<th class="text-center text-white">สินค้า</th>
