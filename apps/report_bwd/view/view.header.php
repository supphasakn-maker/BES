<div class="mb-2">
	<form name="report_bwd">
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<button type="button" class="btn btn-primary" onclick="fn.app.report_bwd.generate();return false;">Search</button>
			</div>
		</div>
		...
		<div class="form-group row display-group" display-group="platform">
			<label class="col-sm-2 col-form-label text-right">Platform </label>
			<div class="col-sm-2">
				<select name="plat_form" class="form-control">
