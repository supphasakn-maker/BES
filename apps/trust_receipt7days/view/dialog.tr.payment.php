<?php
	...
	$html .= '<table class="table table-sm table-bordered">';
		...
		$sql = "SELECT  
			...
			SUM((bs_purchase_usd.amount*bs_purchase_usd.rate_exchange)+bs_transfer_usd.premium) AS amount
	...
	$sql = "SELECT
			bs_transfer_usd.date AS date,
			SUM((bs_purchase_usd.amount*rate_exchange)+bs_transfer_usd.premium) AS amount
