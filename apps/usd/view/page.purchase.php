...
<style>
	...
	#tblPurchase thead th:not(:last-child)::after {
		content: '';
		position: absolute;
		right: 0;
		top: 25%;
	...
	#tblPurchase tbody tr:last-child td {
		border-bottom: none;
	}
		...
		<div class="col-xl-9 col-lg-8">
			<div class="data-section">
				...
				<div class="table-responsive">
					<table id="tblPurchase" class="table table-striped table-hover" width="100%">
						<thead class="bg-dark">
							<tr>
								...
								<th class="text-center text-white">Splited</th>
...
<script>
	$(document).ready(function() {
		...
		function fixSelectHeight() {
			$('form[name="form_addusd"] select, form[name="form_addusd"] input, form[name="form_addusd"] .form-control').each(function() {
				$(this).css({
					'height': '58px',
					'line-height': '25px',
					'padding': '20px 15px',
			...
			// เฉพาะ select
			$('form[name="form_addusd"] select').css({
				'padding-right': '50px',
