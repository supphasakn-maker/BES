...
$("#tblAdjust").DataTable({
	...
	"createdRow": function ( row, data, index ) {
		...
		s = '';
		s += fn.ui.button("btn btn-xs btn-outline-dark","far fa-pen","fn.app.stock_type_bwd.adjust.dialog_edit("+data[0]+")");
		$("td", row).eq(7).html(s);
	}
});
