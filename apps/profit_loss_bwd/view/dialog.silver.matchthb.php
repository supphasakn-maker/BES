...
class myModel extends imodal
{
    function body()
    {
        ...
        if (isset($this->param['sales'])) {
            ...
            echo 'Total <span id="silver_total_match_order_total" class="badge">100</span>';
            echo '</th>';
            echo '</tr>';
            echo '</tfoot>';
            echo '<thead>';
            ...
            foreach ($this->param['sales'] as $sales) {
                ...
                if ($dbc->HasRecord("bs_mapping_profit_orders_bwd", "order_id='" . $check_id . "' AND mapping_id IS NULL")) {
                    $mapping = $dbc->GetRecord("bs_mapping_profit_orders_bwd", "*", "order_id='" . $check_id . "' AND mapping_id IS NULL");
                    ...
                    $onchange = "fn.app.profit_loss_bwd.profitloss.dialog_matchthb_calculation()";
                    ...
                    echo '<td class="p-0">';
                    $class = "form-control form-control-sm text-center rounded-0 border-dark";
                    $onchangetotal = "fn.app.profit_loss_bwd.profitloss.dialog_matchthb_calculationtotal()";
...
$modal->setModel("dialog_match_silver", "SUM THB");
$modal->setExtraClass("modal-lg");
$modal->setButton(array(
    array("close", "btn-secondary", "Dismiss"),
    array("action", "btn-danger", "SUM THB", "fn.app.profit_loss_bwd.profitloss.matchthb()")
));
$modal->EchoInterface();
