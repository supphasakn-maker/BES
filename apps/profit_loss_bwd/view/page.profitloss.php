<table id="tblSales" class="table table-sm table-striped table-bordered table-hover table-middle" width="100%">
    <thead>
        <tr>
            <th class="text-white bg-dark text-center font-weight-bold" colspan="8">ORDERS BOWINS DESIGN</th>
        </tr>
        <tr>
    ...
    <tfoot>
        <tr>
            <td class="text-center bg-primary  font-weight-bold text-white" colspan="7">
        ...
        <tr>
            <td class="text-center bg-info font-weight-bold" colspan="3"></td>
        ...
        <tr>
            <td class="text-center bg-warning font-weight-bold" colspan="3"></td>
            <td class="text-right bg-warning font-weight-bold">
                <span class="total_amountusdday font-weight-bold text-dark"></span>
            </td>
            <td class="text-center bg-warning font-weight-bold"></td>
            <td class="text-right text-dark bg-warning font-weight-bold">
...
<div class=" mb-2">
    <button class="btn btn-info font-weight-bold" onclick="fn.app.profit_loss_bwd.profitloss.dialog_matchthb()">SUM THB</button>
    <button class="btn btn-warning font-weight-bold" onclick="fn.app.profit_loss_bwd.profitloss.dialog_matchusd()">SUM USD</button>
</div>
<br>
...
<div class="row">
    <div class="col-6">
        <table id="tblPurchase" class="table table-sm table-striped table-bordered table-hover table-middle" width="100%">
            ...
            <tfoot>
                <tr>
                    <td class="text-center bg-warning font-weight-bold" colspan="7">
    ...
    <div class="col-6">
        ...
        <table id="tblPurchaseSpot" class="table table-sm table-striped table-bordered table-hover table-middle" width="100%">
            ...
            <tfoot>
                ...
                <tr>
                    <td class="text-center bg-warning" colspan="2"></td>
                    <td class="text-right bg-warning">
                        <span class="total_amount font-weight-bold text-dark"></span>
                    </td>
                    <td class="text-center bg-warning" colspan="2"></td>
                    <td class="text-right bg-warning font-weight-bold text-dark">
                        <span class="total font-weight-bold text-dark"></span> USD
                    </td>
                    <td class="text-center bg-warning" colspan="2"></td>
                </tr>
            </tfoot>
...
<div class="row">
    <div class="col-6">
        <table id="tblPurchaseUSD" class="table table-sm table-striped table-bordered table-hover table-middle" width="100%">
            ...
            <tfoot>
                <tr>
                    <td class="text-center bg-warning font-weight-bold" colspan="8">
