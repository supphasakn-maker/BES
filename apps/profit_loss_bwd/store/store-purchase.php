...
$where = "bs_purchase_spot.parent IS NULL
			...
			AND (
				bs_purchase_spot.ref = 'BWD'
				OR (bs_purchase_spot.currency = 'THB' AND bs_purchase_spot.supplier_id = '28')
				OR (bs_purchase_spot.currency = 'USD' AND bs_purchase_spot.ref = 'BWD')
			)
			...
			AND bs_purchase_spot.date >= '2025-10-01'";
