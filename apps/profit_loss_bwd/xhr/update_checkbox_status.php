...
try {
    ...
    $sql_usd = "UPDATE bs_mapping_profit_sumusd_bwd SET is_checked = $is_checked WHERE $date_condition_usd";
    $sql_thb = "UPDATE bs_mapping_profit_bwd SET is_checked = $is_checked WHERE $date_condition_thb";
