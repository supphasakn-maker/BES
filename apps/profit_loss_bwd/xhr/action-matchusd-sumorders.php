...
if (count($_POST['order_id']) < 1) {
    ...
    if ($dbc->Insert("bs_mapping_profit_sumusd_bwd", $data)) {
        ...
        for ($i = 0; $i < count($_POST['order_id']); $i++) {
            ...
            if ($_POST['order_mapping_id'][$i] == "") {
                $dbc->Insert("bs_mapping_profit_orders_usd_bwd", $data);
                ...
                $mapping = $dbc->GetRecord("bs_mapping_profit_orders_usd_bwd", "*", "id=" . $_POST['order_mapping_id'][$i]);
                ...
                $dbc->Update("bs_mapping_profit_orders_usd_bwd", array(
                    "#amount" => $_POST['order_amount'][$i],
                    "#total" => $_POST['order_total'][$i],
                    "#mapping_id" => $mapping_id
