fn.app.profit_loss_bwd.profitloss.dialog_editspot = function (id) {
    $.ajax({
        url: "apps/profit_loss_bwd/view/dialog.spot.edit.php",
        data: { id: id },
        type: "POST",
        dataType: "html",
...
fn.app.profit_loss_bwd.profitloss.editspot = function () {
    $.post("apps/profit_loss_bwd/xhr/action-edit-spot.php", $("form[name=form_editspot]").serialize(), function (response) {
        if (response.success) {
