...
<ul class="list-group list-group-horizontal">
	...
	<li class="list-group-item flex-fill text-center">
		<div class="text-secondary">RATE SIGMARGIN</div>
		<h1><strong id="exchange_rate"><?php echo number_format($rate_exchange_sigmargin, 4); ?></strong></h1>
		<button class="btn btn-warning" onclick="fn.app.rate_exchange.master.dialog_change_exchange_sigmargin()">Change</button>
	</li>
</ul>