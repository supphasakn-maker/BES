...
if ($dbc->HasRecord("bs_customers", "name = '" . $_POST['name'] . "'")) {
	...
	echo json_encode(array(
		'success' => false,
		'msg' => 'Plese input phone'
	));
} else 	if ($_POST['shipping_address'] == "") {
	echo json_encode(array(
		'success' => false,
		'msg' => 'Plese input Shipping address'
	));
} else 	if ($_POST['billing_address'] == "") {
	echo json_encode(array(
		'success' => false,
		'msg' => 'Plese input Billing address'
	));
} else 	if ($_POST['default_sales'] == "") {
	echo json_encode(array(
		'success' => false,
		'msg' => 'Plese input Sales'
	));
} else 	if ($_POST['org_taxid'] == "") {
	echo json_encode(array(
		'success' => false,
		'msg' => 'Plese input id'
	));
