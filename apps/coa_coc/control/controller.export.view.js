$("#tblExport").DataTable({
    ...
    "serverSide": true,
    "ajax": {
        url: "apps/coa_coc/store/store-export.php",
        data: function (d) {
            d.date = $("#date").val()
        }
    },
    ...
    "createdRow": function (row, data, index) {
        ...
        if (data.status == "2") {
            ...
            s += fn.ui.button("btn btn-xs btn-outline-dark mr-1", "far fa-print", "fn.navigate('coa_coc','view=printableexport&order_id=" + data[0] + "')");
        }
