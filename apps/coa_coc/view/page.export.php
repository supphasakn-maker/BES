...
<div class="btn-area btn-group mb-2">
    <input id="date" type="date" type="date" class="form-control" value="<?php echo date("Y-m-d", $today) ?>" onchange="$('#tblExport').DataTable().draw();">
</div>
<table id="tblExport" class="table table-striped table-bordered table-hover table-middle" width="100%">
