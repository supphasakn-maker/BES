	...
	<div class="row">
		<div class="col-12">
			<div class="mb-2">
				<button class="btn btn-warning" type="button" onclick="fn.app.production_blackdust.import.dialog_lookup(<?php echo $production['id']; ?>);">เพิ่มเศษ (นำเข้า)</button>
				<button class="btn btn-primary" type="button" onclick="fn.app.production_blackdust.prepare.dialog_add_scrap(<?php echo $production['id']; ?>);">เพิ่มเศษ (นำออก)</button>
			</div>
	...
	<div class="row">
		<div class="mb-2">
			...
			<button class="btn btn-primary" type="button" onclick="fn.app.production_blackdust.prepare.append_import(null,true);">Append</button>
		</div>
					...
					if (isset($production['data']))
						if ($production['data'] != null) {
							...
							foreach ($data['import'] as $import) {
								$onChange = "fn.app.production_blackdust.prepare.calcuate_import()";
								echo '';
								echo '<tr>';
