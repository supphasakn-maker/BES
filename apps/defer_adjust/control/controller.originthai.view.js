...
$("#tblThai").DataTable({
    ...
    "serverSide": true,
    "ajax": {
        "url": "apps/defer_adjust/store/store-adjust-thb.php"
    },
    "aoColumns": [
    ...
    "createdRow": function (row, data, index) {
        ...
        s = '';
        s += fn.ui.button("btn btn-xs btn-outline-danger mr-1", "far fa-trash", "fn.app.defer_adjust.adjust_thb.remove(" + data[0] + ")");
        s += fn.ui.button("btn btn-xs btn-outline-dark mr-1", "far fa-pen", "fn.app.defer_adjust.adjust_thb.dialog_edit(" + data[0] + ")");
        $("td", row).eq(4).html(s);
    }
});
