            ...
            <div class="table-card">
                <div class="table-header">
                    <div class="header-content">
                        ...
                        <div>
                            <h3 class="header-title">Tracking Bowins Design</h3>
                        ...
                        <table id="tblOrder" class="table table-sm table-striped table-bordered table-hover table-middle custom-datatable" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">จำนวน / แท่ง</th>
                                    <th class="text-center">ราคา / กรัม</th>
                                    <th class="text-center">Platform</th>
                                    <th class="text-center">ยอดรวม</th>
                                    <th class="text-center">กล่อง</th>
                                    <th class="text-center">สั่งซื้อ</th>
                                    <th class="text-center">ส่งของ</th>
                                    <th class="text-center">วิธีจัดส่ง</th>
                                    <th class="text-center">จัดเตรียม</th>
