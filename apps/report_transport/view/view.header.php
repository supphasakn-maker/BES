<div class="mb-2">
	<form name="report">
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<button type="button" class="btn btn-primary" onclick="fn.app.report_transport.generate();return false;">Search</button>
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			<label class="col-sm-2 col-form-label text-right">เจ้าหน้าที่จัดส่ง </label>
			<div class="col-sm-2">
				<select name="user_group_id" class="form-control">
					<?php
						$sql ="SELECT * FROM bs_employees WHERE department = '2' ";
						$rst = $dbc->Query($sql);
