<?php
	...
	$os = new oceanos($dbc);
	$quick_order = $dbc->GetRecord("bs_orders_buy","*","id=".$_POST['id']);

	$modal = new imodal($dbc,$os->auth);

	$modal->setModel("dialog_edit_quick_buyorder","Edit Quick_order");
	$modal->initiForm("form_editquick_buyorder");
	$modal->setExtraClass("modal-lg");
	$modal->setButton(array(
		array("close","btn-secondary","Dismiss"),
		array("action","btn-outline-dark","Save Change","fn.app.sales_silver.quick_buyorder.edit()")
	));
