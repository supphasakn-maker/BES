	...
	App.loadPlugins(plugins, null).then(() => {
		...
		switch ($panel->getView()) {
			...
			case "difference":
				...
				include "control/controller.difference.insure_15.js";
				include "control/controller.difference.insure_50.js";
				include "control/controller.difference.insure_150.js";
				break;
		}
		?>
