...
$table = array(
	...
	"where" => "bs_purchase_spot.noted = 'Close-Adjust' AND bs_purchase_spot.supplier_id IN (1,6) AND bs_purchase_spot.adjust_id IS NULL AND bs_purchase_spot.date > '2025-01-15'"
);
