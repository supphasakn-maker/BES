...
$columns = array(
	...
	"spot_value" => "FORMAT(bs_sales_spot.amount*bs_sales_spot.rate_spot*32.1507,4)",
	"spot_discount" => "FORMAT(bs_sales_spot.amount*bs_sales_spot.rate_pmdc,4)",
	"spot_net" => "FORMAT(bs_sales_spot.amount*(bs_sales_spot.rate_spot+bs_sales_spot.rate_pmdc)*32.1507,4)",
...
$table = array(
	...
	"where" => "bs_sales_spot.adjust_id IS NULL AND bs_sales_spot.type = 'physical' AND bs_sales_spot.date > '2025-01-15'"
);
