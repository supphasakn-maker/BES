...
fn.app.sigmargin.overview.calculate = function () {
	...
	var rate_exchange = parseFloat($("input[name=rate_exchange]").val()) || 57.5000;
	...
	for (i in data) {
		...
		if (data[i][0] == 'NAG') {
			s += '<td class="text-center"><input type="text" class="form-control form-control-sm text-center" value="' + rate_exchange.toFixed(4) + '"></td>';
