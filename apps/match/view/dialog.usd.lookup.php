<?php
		...
		function body(){
			...
			echo '<div class="row">';
				...
				echo '<div class="col-sm-6">';
					$sql = "SELECT * FROM bs_mapping_usd_spots WHERE mapping_id = ".$map_item['id'];
					$rst = $dbc->Query($sql);
				...
				echo '<div class="col-sm-6">';
					...
					$sql = "SELECT * FROM bs_mapping_usd_purchases WHERE mapping_id = ".$map_item['id'];
					$rst = $dbc->Query($sql);
					echo '<table class="table table-bordered table-striped">';
						echo '<thead>';
							echo '<tr>';
	...
	$modal->setModel("dialog_lookup_usd","Lookup Usd");
