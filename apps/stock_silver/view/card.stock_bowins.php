...
<div class="card mb-2">
	<div class="card-body">
		<div class="btn-area btn-group mb-2">
			<button type="button" class="btn btn-light" onclick='fn.app.stock_silver.silver.dialog_add()'><i class="fas fa-plus"></i> รับแท่งเข้า 1 แท่ง</button>
			<button type="button" class="btn btn-light" onclick='fn.app.stock_silver.silver.dialog_add_multiple()'><i class="fas fa-plus"></i> รับแท่งเข้า หลายแท่ง</button>
