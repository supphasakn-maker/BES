...
if (empty($_SESSION['auth']['user_id'])) {
    ...
    $data = array(
        ...
        "#rate_finance" => $_POST['rate_finance'],
        "date" => $_POST['date'],
    ...
    if ($dbc->Update("bs_purchase_usd", $data, "id=" . $_POST['id'])) {
        ...
        $dbc->Update("bs_purchase_usd_profit_bwd", $data2, "purchase=" . $_POST['id']);

        $usd = $dbc->GetRecord("bs_purchase_usd", "*", "id=" . $_POST['id']);
        $os->save_log(0, $_SESSION['auth']['user_id'], "usd-finance-edit", $_POST['id'], array("usd" => $usd));
    } else {
        echo json_encode(array(
            'success' => false,
            'msg' => "No Change"
