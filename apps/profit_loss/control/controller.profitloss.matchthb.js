fn.app.profit_loss.profitloss.dialog_matchthb = function () {
    var sales_selected = $("#tblSales").data("selected");
    var date_filter = $('#tblSales_length input[name=date_filter]').val();

    $.ajax({
        url: "apps/profit_loss/view/dialog.silver.matchthb.php",
        data: {
        ...
        success: function (html) {
            ...
            fn.app.profit_loss.profitloss.dialog_matchthb_calculation();
            fn.app.profit_loss.profitloss.dialog_matchthb_calculationtotal();
        }
    });
};
fn.app.profit_loss.profitloss.dialog_matchthb_calculation = function () {
...
fn.app.profit_loss.profitloss.dialog_matchthb_calculationtotal = function () {
...
fn.app.profit_loss.profitloss.matchthb = function () {
    $.post("apps/profit_loss/xhr/action-match-sumorders.php", $("form[name=form_matchsilver]").serialize(), function (response) {
        if (response.success) {
