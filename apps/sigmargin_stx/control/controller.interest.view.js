...
$("#tblInterest").DataTable({
	...
	"processing": true,
	"serverSide": true,
	"ajax": "apps/sigmargin_stx/store/store-interest.php",
	"aoColumns": [
	...
	"createdRow": function (row, data, index) {
		...
		s = '';
		s += fn.ui.button("btn btn-xs btn-outline-dark", "far fa-pen", "fn.app.sigmargin_stx.interest.dialog_edit(" + data[0] + ")");
		$("td", row).eq(4).html(s);
	}
});
