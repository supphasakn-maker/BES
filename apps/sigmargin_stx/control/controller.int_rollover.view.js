...
$("#tblInt_rollover").DataTable({
    ...
    "serverSide": true,
    "ajax": {
        "url": "apps/sigmargin_stx/store/store-int_rollover.php",
        "data": function (d) {
            d.extra = 1;
    ...
    "createdRow": function (row, data, index) {
        ...
        s = '';
        s += fn.ui.button("btn btn-xs btn-outline-dark", "far fa-pen", "fn.app.sigmargin_stx.int_rollover.dialog_edit(" + data[0] + ")");
        $("td", row).eq(5).html(s);
    }
});
