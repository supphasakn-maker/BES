	...
	<table id="tblSpot" class="table table-sm table-striped table-bordered table-hover table-middle " width="100%">
		...
		<tfoot>
			<tr>
				...
				<th class="text-center"><input class="form-control text-right" name="total_selected" type="" value="0.00"></th>
				<th class="text-center"><input class="form-control text-right" name="rate_pdmc" type="hidden" value="0.00"></th>
