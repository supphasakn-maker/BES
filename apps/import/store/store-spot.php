...
$table = array(
	...
	"where" => "bs_purchase_spot.status = 1 AND bs_purchase_spot.type LIKE 'physical' AND date > '2025-01-02' AND (bs_purchase_spot.supplier_id = 1 OR bs_purchase_spot.supplier_id = 6) AND bs_purchase_spot.trade_id IS NULL AND bs_purchase_spot.adjust_id IS NULL AND bs_purchase_spot.defer_id IS NULL"
);
