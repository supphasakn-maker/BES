	...
	$("#tblPacking").DataTable({
		...
		"createdRow": function ( row, data, index ) {
			...
			$("td", row).eq(5).html('<input data-id="'+data.id+'" onchange="fn.app.production_prepare.prepare.pack_update(this)" class="form-control form-control-sm" value="'+(data.weight_actual==null?"":data.weight_actual)+'">');
