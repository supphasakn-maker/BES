...
<div class="row">
	<div class="col-6">
		<table id="tblPurchaseSpot" class="table table-sm table-striped table-bordered table-hover table-middle" width="100%">
			<thead>
				<tr><th class="text-white bg-dark text-center" colspan="9">Purchase Spot</th></tr>
				<tr>
					<th class="text-center hidden-xs">
	...
	<div class="col-6">
		<table id="tblPurchaseUSD" class="table table-sm table-striped table-bordered table-hover table-middle" width="100%">
			<thead>
				<tr><th class="text-white bg-dark text-center" colspan="8">Purchase USD</th></tr>
				<tr>
					<th class="text-center hidden-xs">
					...
					<th class="text-center">Amount</th>
					<th class="text-center">Exchange Rage</th>
