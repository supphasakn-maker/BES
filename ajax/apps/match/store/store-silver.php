<?php
	...
	$columns = array(
		...
		"amount" => "bs_mapping_silvers.amount",
		...
		"purchase_amount" => "(SELECT SUM(bs_mapping_silver_purchases.amount) FROM bs_mapping_silver_purchases WHERE bs_mapping_silver_purchases.mapping_id = bs_mapping_silvers.id)",
