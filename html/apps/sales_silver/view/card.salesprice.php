...
<script>
	...
	// Enhanced fetchBowinsDesignPrice function
...
ขนาด 15 กรัม (น้ำหนัก 0.99 บาท) - ${price15} บาท
ขนาด 50 กรัม (น้ำหนัก 3.29 บาท) - ${price50} บาท
ขนาด 150 กรัม (น้ำหนัก 9.87 บาท) - ${price150} บาท
...
อัพเดทเมื่อ: ${new Date().toLocaleString('th-TH')}`;
	...
	// Enhanced copy functions with notifications
	function copyText1() {
	...
	function startAutoUpdate() {
		...
		if (!isAutoUpdating) {
			isAutoUpdating = true;
			autoUpdateInterval = setInterval(fetchBowinsDesignPrice, 30000); // 30 seconds
