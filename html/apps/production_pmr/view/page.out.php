...
<div class="btn-area btn-group mb-2">
    <form name="filter" class="form-inline mr-2" onsubmit="return false;">
        ...
        <button type="button" class="btn btn-primary" onclick='$("#tblOut").DataTable().draw();'>Lookup</button>
    </form>
</div>
<table id="tblOut" class="table table-striped table-bordered table-hover table-middle" width="100%">
    <thead class="bg-dark">
        <tr>
            <th class="text-center text-white text-bold">วันที่</th>
