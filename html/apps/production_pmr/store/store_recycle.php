...
if (isset($_GET['date_from'])) {
    $where .= " AND date(bs_productions_pmr.created) BETWEEN '" . $_GET['date_from'] . "' AND '" . $_GET['date_to'] . "' AND bs_productions_pmr.product_id = '4' AND bs_productions_pmr.weight_out_packing = 0";
}
