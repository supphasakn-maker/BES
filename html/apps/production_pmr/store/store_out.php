...
if (isset($_GET['date_from'])) {
    $where .= " AND date(bs_productions_pmr.created) BETWEEN '" . $_GET['date_from'] . "' AND '" . $_GET['date_to'] . "' AND bs_productions_pmr.weight_out_packing != 0";
}
$where .= " AND bs_productions_pmr.remark NOT REGEXP '(ส่งเม็ดผลิต|ส่งเม็ด)'";
