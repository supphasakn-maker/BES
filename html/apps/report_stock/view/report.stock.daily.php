					...
					<table class="table table-sm table-bordered">
						...
						<tbody>
							<tr style="height: 75px;">
								...
								<?php
								$local_recycle_data = calculateStockImproved($dbc, 7, 0, $start_date, $today, $previousdate);
								echo '<td class="text-center number-display balance-positive">';
								echo number_format($local_recycle_data['today_balance'], 4);
								echo '</td>';
								?>
							</tr>
							<tr style="height: 85px;">
								...
								<?php
								$balance_class = $local_recycle_data['final_balance'] >= 0 ? 'balance-positive' : 'balance-negative';
								echo '<th class="text-center number-display ' . $balance_class . '">';
								echo number_format($local_recycle_data['final_balance'], 4);
								echo '</th>';
								?>
							</tr>
						</tbody>
						...
						<tr class="summary-row">
							...
							<th class="text-center" colspan="1">
								...
								$total_all = $silver_data_correct['current_balance'] + $lbma_data_correct['current_balance'] +
									...
									$silver_plate_data_correct['current_balance'] + $local_recycle_data['final_balance'] + $silver_article_data_correct['current_balance'];
