...
$aDate = array();
$PID = array(1, 3, 4, 5, 2, 6, 7, 8);
$aBalance = array(1204, 206.6716, 0.009, 1.3003, 42, 0, 0, 0);
$aTotal = array();
$aProduct = array();
				...
				<tbody>
					...
					<tr>
						...
						foreach ($aDate as $date) {
							...
							echo '<td class="text-center text-dark font-weight-bold day-border" style="' . $style . '; --border-color: ' . $borderColor . ';" colspan="8">';
					...
					<tr>
						...
						for ($i = 0; $i < count($aTotal); $i++) {
							...
							$borderColor = getDayBorderColor($aDate[$i]);
							echo '<td class="text-center day-border font-weight-bold" style="' . $dayStyle . '; --border-color: ' . $borderColor . ';" colspan="8">';
