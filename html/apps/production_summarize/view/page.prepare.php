...
<table id="tblPrepare" class="table table-striped table-bordered table-hover table-middle" width="100%">
	<thead class="bg-dark">
		<tr>
			<th class="text-center text-white font-weight">วันที่เปิดรอบการผลิต</th>
			<th class="text-center text-white font-weight">รอบที่</th>
			<th class="text-center text-white font-weight">จำนวนถุง</th>
			<th class="text-center text-white font-weight">จำนวนกระสอบ</th>
			<th class="text-center text-white font-weight">นำหนักเข้าหลอม</th>
			<th class="text-center text-white font-weight">น้ำหนักออก</th>
			<th class="text-center text-white font-weight">ผลต่าง</th>
			<th class="text-center text-white font-weight">น้ำหนักแพ็ค</th>
			<th class="text-center text-white font-weight">บันทึก</th>
