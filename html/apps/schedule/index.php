...
} else if ($panel->getView() == "printablesalebf") {
	include "view/page.ordersalebf.view.php";
} else if ($panel->getView() == "printablebf") {
	include "view/page.orderbf.view.php";
} else if ($panel->getView() == "printabletrustreceipt") {
	include "view/page.trustreceipt.view.php";
} else if ($panel->getView() == "printableprocessinglosscustom") {
	include "view/page.processinglosscustom.view.php";
} else if ($panel->getView() == "printable_processing_product") {
	include "view/page.printable_processing_product.view.php";
} else if ($panel->getView() == "printable_silver_over") {
	include "view/page.printable_silver_over.view.php";
} else {
	echo '<div class="row">';
