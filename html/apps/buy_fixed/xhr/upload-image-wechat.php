...
try {
    ...
    $existingRecord = $dbc->GetRecord("bs_purchase_buy", "id", "id=" . $recordId);
    if (!$existingRecord) {
    ...
    $newFileName = 'wechat_' . $recordId . '_' . date('YmdHis') . '.' . $fileExtension;
    ...
    $updateResult = $dbc->Update("bs_purchase_buy", $updateData, "id=" . $recordId);
    ...
    $response = array(
        ...
        'file_path' => 'binary/wechat/' . $fileNameForDB,
