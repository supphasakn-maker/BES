...
$("#tblAdjust").DataTable({
    ...
    "processing": true,
    "serverSide": true,
    "ajax": "apps/production_over/store/store-adjust.php",
    "aoColumns": [
        { "bSortable": false, "data": "id", "sClass": "hidden-xs text-center", "sWidth": "20px" },

        { "bSort": true, "data": "date", "sClass": "text-center" },
        { "bSort": true, "data": "code_no", "sClass": "text-center" },
    ...
    "createdRow": function (row, data, index) {
        ...
        s = '';
        s += fn.ui.button("btn btn-xs btn-outline-dark", "far fa-pen", "fn.app.production_over.adjust.dialog_edit(" + data[0] + ")");
        $("td", row).eq(7).html(s);
    }
});
