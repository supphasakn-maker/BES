<div class="container-fluid">
  <div class="row">
    <div class="col-sm-6">
		...
		WHERE  DATE_FORMAT(bs_orders.delivery_date,'%Y-%m') = '".$_POST['month']."' AND bs_deliveries_drivers.emp_driver = '".$_POST['user_group_id']."' 
		...
		<tfoot>
			...
			<th class="text-center" colspan="3">รวมเป็นเงิน <?php echo $aSum[1]; ?>  บาท</th>
			</tr>
		</tfoot>
		</table>
    </div>
