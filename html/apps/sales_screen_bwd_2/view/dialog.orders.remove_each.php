<?php
// ใน dialog.orders.remove_each.php ให้เพิ่ม debug
session_start();
...
$modal->setModel("dialog_remove_each_orders", "Remove Order");
$modal->initiForm("form_remove_eachorder");
$modal->setExtraClass("modal-lg");
$modal->setButton(array(
    array("close", "btn-secondary", "Dismiss"),
    array("action", "btn-danger", "Remove", "fn.app.sales_screen_bwd_2.multiorder.remove_each()")
));
...
echo "<!-- DEBUG: Order ID = " . $order['id'] . ", Customer = " . $order['customer_name'] . " -->";
