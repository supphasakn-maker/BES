fn.app.sales_screen_bwd_2.multiorder.dialog_remove_each = function (id) {
    $.ajax({
        url: "apps/sales_screen_bwd_2/view/dialog.orders.remove_each.php",
        data: { id: id },
        type: "POST",
        dataType: "html",
...
fn.app.sales_screen_bwd_2.multiorder.remove_each = function () {
    ...
    $.post("apps/sales_screen_bwd_2/xhr/action-remove_each-orders.php",
        formData,
        function (response) {
