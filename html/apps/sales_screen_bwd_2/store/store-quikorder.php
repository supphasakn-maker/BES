...
try {
    ...
    // Columns with proper subqueries for item count and totals
    $columns = array(
        "id" => "bs_orders_bwd.id",
        ...
        // รวมยอดสุทธิจาก main order + sub orders  
        ...
        // นับจำนวนรายการทั้งหมด (main + sub orders)
    ...
    // แปลงรูปแบบข้อมูลจาก DataStore เป็นรูปแบบที่ DataTables ต้องการ
