...
$table = array(
	...
	"where" => "bs_deliveries.delivery_date = '" . $_GET['date'] . "' AND bs_orders.status > 0 AND (bs_orders.product_id = 2 OR bs_orders.product_id = 3 OR bs_orders.product_id = 4 OR bs_orders.product_id = 5 OR bs_orders.product_id = 7)"
);
