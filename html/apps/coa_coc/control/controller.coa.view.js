$("#tblCOA").DataTable({
	...
	"serverSide": true,
	"ajax": {
		url : "apps/coa_coc/store/store-coa.php",
		data : function(d){
	...
	"createdRow": function ( row, data, index ) {
		...
		if(data.total_item > 0){
			...
			s += fn.ui.button("btn btn-xs btn-outline-dark mr-1","far fa-print","fn.navigate('coa_coc','view=printablecoa&order_id="+data[0]+"')");
		}
