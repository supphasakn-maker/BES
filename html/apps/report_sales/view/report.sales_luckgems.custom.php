<table class="table table-sm table-bordered table-striped">
    ...
    <tbody>
		...
		where   DATE(bs_orders.date) BETWEEN '" . $_POST['date_from'] . "' AND '" . $_POST['date_to'] . "'  AND bs_orders.parent IS NULL  AND bs_orders.status > -1 AND bs_stock_adjusted.type_id = 12 ";
        $rst = $dbc->Query($sql);
