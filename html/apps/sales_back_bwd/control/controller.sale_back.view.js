$('#tblsaleback').DataTable({
    ...
    "createdRow": function (row, data, index) {
        ...
        $('td', row).eq(6).html(s);
        s += '<a class="btn btn-xs btn-outline-dark mr-1" href="#apps/schedule_bwd_2/index.php?view=printablebf&order_id=' + data.id + '" target="_blank"><i class="far fa-print"></i></a> ';
