...
$("#date_filter").change(function(){
	...
	Cookies.set('delivery-date-filter',$("#date_filter").val(), { expires: 1 });
});


let date_fitler = Cookies.get('delivery-date-filter');
if(typeof date_fitler != "undefined"){
	$("#date_filter").val(date_fitler);
}