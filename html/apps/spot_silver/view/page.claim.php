...
<style>
	...
	#tblClaim thead th:not(:last-child)::after {
		content: '';
		position: absolute;
		right: 0;
		top: 25%;
	...
	#tblClaim tbody tr:last-child td {
		border-bottom: none;
	}
	...
	<div class="row g-0">
		<div class="col-xl-3 col-lg-4">
			<div class="form-section">
				...
				<form name="form_addspot" class="mb-3" onsubmit="fn.app.spot_silver.claim.add();return false;">
		...
		<div class="col-xl-9 col-lg-8">
			<div class="data-section">
				...
				<div class="table-responsive">
					<table id="tblClaim" class="table table-striped table-hover" width="100%">
						<thead class="bg-dark">
							<tr>
								...
								<th class="text-center text-white">CUR</th>
