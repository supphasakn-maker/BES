...
<div class="btn-area btn-group mb-2">
	<form name="filter" class="form-inline mr-2" onsubmit="return false;">
		...
		<button type="button" class="btn btn-primary mr-sm-2" onclick='$("#tblPayment").DataTable().draw();'>Lookup</button>
		<div class="custom-control custom-checkbox">
		  <input name="chkShowCompleted" type="checkbox" class="custom-control-input" id="chkShowCompleted" onclick='$("#tblPayment").DataTable().draw();'>
		  <label class="custom-control-label" for="chkShowCompleted">Show Paid</label>
		</div>
	</form>
</div>
