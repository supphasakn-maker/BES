...
<table class="table table-sm table-bordered table-striped" id="tblDeposit">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM bs_productions WHERE product_id != 2 AND product_id != 5 AND PMR = 'BWS' AND id != 1741 AND submited IS NOT NULL AND submited BETWEEN '" . $_POST['date_from'] . "' AND '" . $_POST['date_to'] . "'";
        $rst = $dbc->Query($sql);
        $number = 1;
