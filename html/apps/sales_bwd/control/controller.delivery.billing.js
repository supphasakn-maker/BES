fn.app.sales_bwd.delivery.dialog_billing = function(id) {
    $.ajax({
        url: "apps/sales_bwd/view/dialog.delivery.billing.php",
        data: {id:id},
        type: "POST",
        dataType: "html",
...
fn.app.sales_bwd.delivery.billing = function(){
    $.post("apps/sales_bwd/xhr/action-billing-delivery.php",$("form[name=form_billingdelivery]").serialize(),function(response){
        if(response.success){
...
fn.app.sales_bwd.delivery.append_billing = function(){
    let s = '';
