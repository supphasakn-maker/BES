...
fn.app.production_silverplate.import.dialog_lookup = function (id) {
    var multiple = true
    $.ajax({
        url: "apps/production_silverplate/view/dialog.import.scrap.php",
        type: "POST",
        data: { id: id },
        dataType: "html",
        success: function (html) {
            ...
            $('#tblImportLookup').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "apps/production_silverplate/store/store-import_scrap.php",
                "aoColumns": [
...
fn.app.production_silverplate.import.dialog_select = function (id) {
    var item_selected = $("#tblImportLookup").data("selected");
    $.ajax({
        url: "apps/production_silverplate/view/dialog.scrap.select.php",
...
fn.app.production_silverplate.import.select = function () {
    $.post("apps/production_silverplate/xhr/action-combine-scrap.php", $("form[name=form_combinescrap]").serialize(), function (response) {
        if (response.success) {
