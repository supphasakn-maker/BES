...
$where = " bs_purchase_usd.status <> -1 AND (bs_purchase_usd.type LIKE 'physical') AND YEAR(date) > 2024";
...
$aaData = array(); // ตัวแปรนี้ไม่ได้ใช้ในโค้ดส่วนนี้ สามารถลบได้หากไม่จำเป็น
$data = $dbc->GetResult();
