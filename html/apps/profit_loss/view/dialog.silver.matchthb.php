    ...
    function body()
    {
        ...
        if (isset($this->param['sales'])) {
            ...
            foreach ($this->param['sales'] as $sales) {
                ...
                if ($dbc->HasRecord("bs_mapping_profit_orders", "order_id=" . $order['order_id'] . " AND mapping_id IS NULL")) {
                    $mapping = $dbc->GetRecord("bs_mapping_profit_orders", "*", "order_id=" . $order['order_id'] . " AND mapping_id IS NULL");
                    ...
                    echo '<td class="p-0">';
                    $class = "form-control form-control-sm text-center rounded-0 border-dark";
                    $onchangetotal = "fn.app.profit_loss.profitloss.dialog_matchthb_dialog_matchthb_calculationtotal()";
...
$modal->setButton(array(
    ...
    array("action", "btn-danger", "SUM THB", "fn.app.profit_loss.profitloss.matchthb()")
));
$modal->EchoInterface();
