fn.app.profit_loss.profitloss.dialog_matchusd = function () {
    var sales_selected = $("#tblSales").data("selected");
    var date_filter = $('#tblSales_length input[name=date_filter]').val();

    $.ajax({
        url: "apps/profit_loss/view/dialog.silver.matchusd.php",
        data: {
        ...
        success: function (html) {
            ...
            fn.app.profit_loss.profitloss.dialog_matchusd_calculation();
            fn.app.profit_loss.profitloss.dialog_matchusd_calculationtotal();
        }
    });
};
fn.app.profit_loss.profitloss.dialog_matchusd_calculation = function () {
...
fn.app.profit_loss.profitloss.dialog_matchusd_calculationtotal = function () {
...
fn.app.profit_loss.profitloss.matchusd = function () {
    $.post("apps/profit_loss/xhr/action-matchusd-sumorders.php", $("form[name=form_matchusdsilver]").serialize(), function (response) {
        if (response.success) {
