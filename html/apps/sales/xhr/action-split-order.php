...
$check_profit_orders = $dbc->GetRecord("bs_mapping_profit_orders", "*", "order_id=" . $_POST['id']);
$check_profit_orders_usd = $dbc->GetRecord("bs_mapping_profit_orders_usd", "*", "order_id=" . $_POST['id']);
