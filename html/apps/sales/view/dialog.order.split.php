...
?>
		...
		<form name="form_splitorder">
			<?php
			$getdelivery = $dbc->GetRecord("bs_delivery_pack_items", "count(delivery_id) as bb", "delivery_id	=" . $order['delivery_id']);
			?>
			<input type="hidden" name="delivery_id" value="<?php echo $getdelivery['bb']; ?>">
