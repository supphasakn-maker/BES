	...
	App.loadPlugins(plugins, null).then(() => {
		...
		switch ($panel->getView()) {
			...
			case "daily":
				...
				if ($os->allow("sigmargin", "add")) include "control/controller.daily.add.js";
				if ($os->allow("sigmargin", "edit")) include "control/controller.daily.edit.js";
				if ($os->allow("sigmargin", "remove")) include "control/controller.daily.remove.js";
				break;
			case "int_rate":
				include "control/controller.int_rate.view.js";
				if ($os->allow("sigmargin", "add")) include "control/controller.int_rate.add.js";
				if ($os->allow("sigmargin", "edit")) include "control/controller.int_rate.edit.js";
				if ($os->allow("sigmargin", "remove")) include "control/controller.int_rate.remove.js";
				break;
			case "int_rollover":
				include "control/controller.int_rollover.view.js";
				if ($os->allow("sigmargin", "add")) include "control/controller.int_rollover.add.js";
				if ($os->allow("sigmargin", "edit")) include "control/controller.int_rollover.edit.js";
				if ($os->allow("sigmargin", "remove")) include "control/controller.int_rollover.remove.js";
				break;
		}
		?>
