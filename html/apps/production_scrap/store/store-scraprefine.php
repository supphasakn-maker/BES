<?php
	...
	$columns = array(
		...
		"pack_type" => "bs_scrap_items.pack_type",
		"difference" => "FORMAT(bs_scrap_items.weight_actual-bs_scrap_items.weight_expected,4)",
		"created" => "bs_scrap_items.created",
		"updated" => "bs_scrap_items.updated",
	...
	$table = array(
		...
		"join" => array(
            ...
            "where" => "bs_scrap_items.pack_name LIKE '%เม็ดเสียรอการ Refine%' AND bs_scrap_items.status > -1 "
	);
