<?php
	...
	$columns = array(
		...
		"spot_value" => "FORMAT(bs_purchase_spot.amount*bs_purchase_spot.rate_spot,4)",
		"spot_discount" => "FORMAT(bs_purchase_spot.amount*bs_purchase_spot.rate_pmdc,4)",
		"spot_net" => "FORMAT(bs_purchase_spot.amount*(bs_purchase_spot.rate_spot+bs_purchase_spot.rate_pmdc),4)",
		...
		"value" => "FORMAT((rate_spot+rate_pmdc)*amount,4)",
	);
	...
	$table = array(
		...
		"where" => "bs_purchase_spot.supplier_id = 1 AND bs_purchase_spot.adjust_id IS NULL"
	);
