<?php
	...
	$start_interest_date = $transfer['transfer_date'];
	if($dbc->HasRecord("bs_usd_payment","purchase_id=".$usd['id'])){
		$payment = $dbc->GetRecord("bs_usd_payment","*","id=".$_POST['id'].' ORDER BY id DESC');
