<?php
			...
			echo '<form name="form_approveprepare">';
				...
				echo '<tbody>';
					echo '<tr>';
						...
						echo '<td><input name="submited" type="datetime" class="form-control" value="'.date("Y-m-d H:i:s").'"></td>';
					echo '</tr>';
				echo '</tbody>';
				echo '</table>';
			echo '</fomr>';
	...
	$modal->setButton(array(
		...
		array("action","btn-danger","Approve","fn.app.production_prepare.prepare.approve()")
	));
	$modal->EchoInterface();
