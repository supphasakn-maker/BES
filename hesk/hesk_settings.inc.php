...
// --> General settings
$hesk_settings['site_title']='Bowins Ticket Management';
$hesk_settings['site_url']='http://192.168.1.33/hesk';
$hesk_settings['hesk_title']='Help Desk';
$hesk_settings['hesk_url']='http://192.168.1.33/hesk';
$hesk_settings['webmaster_mail']='it@bowinsgroup.com';
...
// --> Database settings
$hesk_settings['db_host']='192.168.1.33';
$hesk_settings['db_name']='hesk';
$hesk_settings['db_user']='root';
$hesk_settings['db_pass']='bowin_admin.92';
...
$hesk_settings['secimg_sum']='MZ8M9WU4MQ';
...
$hesk_settings['url_key']='BTd6F7B-n2TV4Q7jaHDXj2qeJQX0M1';
...
$hesk_settings['ticket_list']=array('trackid','lastchange','name','subject','status','owner','replies','staffreplies','lastreplier');
