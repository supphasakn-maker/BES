...
// Calendar
if (hesk_checkPermission('can_run_reports',0)) {
    $pages = array('calendar_tickets', 'calendar_events');
    $open_menu = in_array($calling_script, $pages) ? 'current submenu-is-opened' : '';
?>
<li class="listitem submenu <?php echo $open_menu; ?>">
    <div class="listitem__icon">
    ...
    <div class="listitem__menu">
        <a href="#" class="listitem__caption">Calendar</a>
        <ul class="submenu__list">
            <li class="submenu__listitem <?php if ($calling_script === 'calendar_tickets') { ?>current<?php } ?>">
                <a href="calendar_tickets.php">
                    Ticket Calendar
                </a>
            </li>
            <li class="submenu__listitem <?php if ($calling_script === 'calendar_events') { ?>current<?php } ?>">
